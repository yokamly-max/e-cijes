                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center"><img src="{{ env('APP_URL') }}mail/img/logo_small.jpg" alt="Image" /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td height="10" style="font-size:10px; mso-line-height-rule:exactly; line-height:10px;">&nbsp;</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;" align="left"><strong style="font-size:20px; text-transform:uppercase;">{{ env('APP_NAME') }}</strong><br />
                                                                                    {{ $subject }}</td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">{!! $message !!}</td>
                                                                            </tr>
                                                                            <tr>
