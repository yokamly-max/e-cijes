            ...
            <div class="container">
                <div class="title-outer">
                    <div class="page-title">
                        <h2 class="title">{{ $partenaire->titre }}</h2>
                        <ul class="page-breadcrumb">
                            <li><a href="{{ route('index.index') }}">{{ __('accueil') }}</a></li>
                            <li><a href="{{ route('partenaire.liste') }}">{{ __('partenaire_page') }}</a></li>
                        </ul>
                    </div>
                    <!-- <div class="text">
                   ...
                   <div class="blog-details-left">
                            <div class="blog-list-card style-2">
                                ...
                                <div class="image overlay-anim1">
                                    <a href="#"><img src="{{ env('APP_URL') . $partenaire->vignette }}" alt="{{ $partenaire->titre }}"></a>
                                </div>
								@endif
                                <div class="card-content">
									@if ($partenaire->partenairetype_id > 0)
                                    <span class="category">{{ $partenaire->partenairetype->titre }}</span>
									@endif
                                    <h3 class="title"><a href="#">{{ $partenaire->titre }}</a></h3>
