                ...
                <div class="inner-container">
                    <div class="top-left">
                        <ul class="list-style-1">
                            <li><i class="icon icon-bentol"></i>{!! (__('site_name')) !!}</li>
                            <li><a href="mailto:{{ __('emailsite2') }}"><i class="icon fa-regular fa-envelope"></i>{{ __('emailsite2') }}</a></li>
                        </ul>
                    </div>
                    <div class="outer-box">
                        <ul class="social-icon-one">
                            <li><span class="menu-follow_title">{!! (__('reseauxsociaux')) !!} :</span></li>
                            <li><a href="https://www.facebook.com/people/Conf%C3%A9d%C3%A9ration-des-Juniors-Entreprises-du-Togo/61552961216434/" target="_blank"><i class="fa-brands fa-square-facebook"></i></a></li>
                            <li><a href="https://www.linkedin.com/company/cjet-confederations-des-juniors-entreprises-du-togo/?viewAsMember=true" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a></li>
...
<a href="{{ env('APP_URL2', 'https://p-cijes.cjes.africa/') }}" 
   ...
   rel="noopener noreferrer">
    <span class="link-effect">
        ...
        <span class="effect-1">
            <i class="fa-solid fa-right-to-bracket"></i> {{-- icône login (pour l’effet doublé) --}}
        </span>
    </span>
    {{-- <i class="fa-regular fa-arrow-right-long"></i> flèche à droite --}}
</a>
...
<a href="{{ env('APP_URL2', 'https://p-cijes.cjes.africa/') }}" 
   ...
   rel="noopener noreferrer">
    ...
    align-items: center;" onclick="ouvre_newsletters(document.getElementById('email').value, 'nivonewsletter2');">
