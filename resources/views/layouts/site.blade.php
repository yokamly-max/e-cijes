...
<a href="{{ env('APP_URL2', 'https://p-cijes.cjes.africa/') }}" 
   ...
   rel="noopener noreferrer">
    ...
    {{-- <i class="fa-regular fa-arrow-right-long"></i> flèche à droite --}}
                    ...
                    <!-- Zone droite (desktop uniquement) -->
                    <div class="col-auto header-right-wrapper d-none d-lg-block">
                        <div class="header-right">
                            <a href="tel:{{ __('telephonesite3') }}" class="header-btn">
                                <span class="fa-solid fa-headphones"></span>{{ __('telephonesite2') }}
                            </a>
